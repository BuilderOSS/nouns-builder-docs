...
- [`Auction`](https://github.com/BuilderOSS/nouns-protocol/blob/feat/updatable-proposals/src/auction/Auction.sol): Handles token auctions, bidding logic, and minting of new governance tokens.
- [`Token`](https://github.com/BuilderOSS/nouns-protocol/blob/feat/updatable-proposals/src/token/Token.sol): ERC-721 (NFT) or ERC-20 (fungible) token contract representing DAO membership and voting power.
- [`Governor`](https://github.com/BuilderOSS/nouns-protocol/blob/feat/updatable-proposals/src/governance/governor/Governor.sol): Manages proposals, updates, voting logic and execution of onchain actions.
- [`Treasury`](https://github.com/BuilderOSS/nouns-protocol/blob/feat/updatable-proposals/src/governance/treasury/Treasury.sol): Holds ETH or other native tokens for the DAO and executes approved spending.
- [`Manager`](https://github.com/BuilderOSS/nouns-protocol/blob/feat/updatable-proposals/src/manager/Manager.sol): Deploys DAO contracts and registers permitted implementation upgrades.
...
The original contracts remain valid and in active use. This section documents the `feat/updatable-proposals` implementation, not behaviour shared by every deployed Builder DAO. Existing DAOs opt into the implementation through governance; even after upgrading, proposal updates remain disabled while `proposalUpdatablePeriod()` is zero.
...
- [Proposal candidate EAS schemas](https://github.com/BuilderOSS/nouns-protocol/blob/feat/updatable-proposals/docs/eas-proposal-candidates-schema.md)
