...
Proposal and [Propdate](./src/content/docs/guides/builder-propdates.mdx) notifications are propagated to the existing [Farcaster bot](https://github.com/BuilderOSS/builder-farcaster) using a *CRON* job that runs every hour.
