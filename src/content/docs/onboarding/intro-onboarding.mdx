...
<CardGrid>
  ...
  <LinkCard title="Builder Protocol Technical Reference" href="/contributors/contract-upgrade" />
...
- [Proposal Candidates](/guides/proposal-candidates/)
  Develop an idea, collect member signals and gather sponsor signatures before formal submission.

- [Updating a Proposal](/guides/updating-proposals/)
  Learn how proposers can revise submissions in DAOs that have enabled the updateable proposal contracts.
...
- [Understanding Reward Splits vs Token Allocation](/onboarding/founder-rewards-vs-token-allocation/)
