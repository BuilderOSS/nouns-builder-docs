...
While we recommend to use a commercial third party bridge to access your funds more quickly, Nouns Builder also provides access to native bridges that are more cost-effective. If you do use the native bridges available at [nouns.build/bridge](https://nouns.build/bridge), you will have longer lock times before the bridging transaction is completed and cannot withdraw using the the UI provided by Builder.

For withdrawals and bridging from your L2 DAO treasury to Ethereum Mainnet or another L2, please use the **Wallet Connect** Proposal Template to connect to a third party bridge.
...
From August 2025, bridges provided by Nouns Builder will only be accessible through the [Bridge Tab](https://nouns.build/bridge) as the modal UX was deprecated.
