...
![Wallet Connect](./public/onboarding/getting-startedOnboarding/wallet-connect.png)
...
![Bidding](./public/onboarding/getting-startedOnboarding/bidding.png)
...
![Submit Vote](./public/onboarding/getting-startedOnboarding/submit-vote.png)

---

## 🧑‍💻 For Developers

### How to Fork and Deploy a DAO Using Nouns Builder

Nouns Builder is fully open source and can be forked for custom deployments. If you're developer and want to get started right away, head to the [builder docs section](/contributors/intro_contributors.mdx)

**Steps:**

1. Clone the [Nouns Builder repository](https://github.com/nounsDAO/nouns-builder).
2. Modify DAO parameters in the config files (name, token symbol, auction settings, etc.).
3. Deploy to your preferred Ethereum-compatible network.
4. Launch frontend interfaces or use existing tools like [nouns.build](http://nouns.build/).

![Github](./public/onboarding/getting-startedOnboarding/github.png)
...
![Satoris Knowledge Base](./public/onboarding/getting-startedOnboarding/Satoris_knowledge-base.png)
...
![Builder on Farcaster](./public/onboarding/getting-startedOnboarding/builder-farcaster.png)
