...
DAO upgrades are opt-in. The original Governor remains in use across DAOs and moves proposals directly to **Pending**. The upgraded governance release combines [EAS-based proposal candidates](https://github.com/BuilderOSS/nouns-protocol/blob/e6679a20b38e2a9c35b7dbd75adf5043999dce75/docs/eas-proposal-candidates-schema.md) with an [upgraded Governor](https://github.com/BuilderOSS/nouns-protocol/blob/e6679a20b38e2a9c35b7dbd75adf5043999dce75/src/governance/governor/Governor.sol) that supports revision-aware signing and the optional **Updatable** period. Existing DAOs that upgrade retain a zero-length update period until governance explicitly enables it, so an implementation upgrade alone does not change their proposal timing.

See the [Governor architecture](https://github.com/BuilderOSS/nouns-protocol/blob/e6679a20b38e2a9c35b7dbd75adf5043999dce75/docs/governor-architecture.md) and [upgrade runbook](https://github.com/BuilderOSS/nouns-protocol/blob/e6679a20b38e2a9c35b7dbd75adf5043999dce75/docs/upgrade-runbook.md) for the contract-level distinction.
