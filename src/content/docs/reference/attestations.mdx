...
![EAS Attestaion Flow](./public/guides/propdateGuide/attestation-flow.png)
...
The schema with the UID `0x8bd0d42901ce3cd9898dbea6ae2fbf1e796ef0923e7cbb0a1cecac2e42d47cb3` enables Nouns Builder Propdates. It is deployed on-chain on all networks supported by Nouns Builder, **except ZORA** consisting of mandatory and optional fields. The payload dispalyed on the frontend is wrapped in `message`, which MAY contain a *JSON* string.

### Deployed Schemas

- [Base](https://base.easscan.org/schema/view/0x8bd0d42901ce3cd9898dbea6ae2fbf1e796ef0923e7cbb0a1cecac2e42d47cb3),
- **EAS, hence Nouns Builder Propdates are not available on Zora Mainnet.**
...
- **EAS, hence Nouns Builder Propdates are not available on Zora Sepolia.**
