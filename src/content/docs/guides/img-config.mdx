...
It is generated in the [Metadata Render Contract](https://github.com/BuilderOSS/nouns-protocol/blob/main/src/token/metadata/MetadataRenderer.sol#L279) by calling `_generateSeed` with the current tokenId and salting the hash with block data.
