...
![daoSettings](../../../assets/images/builderProtocolRewards.png)
...
1.  **Builder DAO Reward** - 2.5%
    Builder DAO, the DAO responsible for developing and maintaining the protocol, receives this reward. Learn more about Builder DAO [here](https://nouns.build/dao/base/0xe8af882f2f5c79580230710ac0e2344070099432/699?tab=about).
...
:::note[Legacy Zora Network deployment]

The historic Builder DAO rewards recipient on Zora Network is `0x7229F0c537e64f3EA9E9b993601578A7B09c402C`. It is retained here for existing deployments and should not be interpreted as current support for launching or bridging to Zora Network.
