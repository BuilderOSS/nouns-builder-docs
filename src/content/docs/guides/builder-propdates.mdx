...
Users can access the Propdate functionality by navigating to `Activity` of their DAO, select a specific proposal, and scroll down. Propdates are currently available on all supported networks by Nouns Builder, **except ZORA**. 
