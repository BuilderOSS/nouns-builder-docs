...
Use the split address in the [Splits app](https://app.splits.org/) or a block explorer to confirm the distribution transaction and recipient balances. A recipient's wallet receives funds only after withdrawal completes.
