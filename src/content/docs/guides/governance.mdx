...
| **Upgraded Governor, update period set to `0`** | Pending | No, updates are disabled while the period is `0` | Upgraded ABI and revision reads |
...
The upgraded implementation and its design documentation are available in the pinned protocol revision:
...
- [Governor interface](https://github.com/BuilderOSS/nouns-protocol/blob/e6679a20b38e2a9c35b7dbd75adf5043999dce75/src/governance/governor/IGovernor.sol)
- [Proposal lifecycle reference](https://github.com/BuilderOSS/nouns-protocol/blob/e6679a20b38e2a9c35b7dbd75adf5043999dce75/docs/governor-proposal-lifecycle.md)
