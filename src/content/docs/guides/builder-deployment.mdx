...
:::note 
We highly recommend first creating a test DAO on the [Sepolia Testnet](https://testnet.nouns.build/) before creating one on Mainnet.

We also recommend using a personal wallet to create your DAO. Creating a DAO with a [Safe multisig](https://safe.global/) is currently not supported. 

- Visit Testnet **[here](https://testnet.nouns.build/)**.
- Obtain Sepolia ETH **[here](https://sepolia-faucet.pk910.de/)**, **[here](https://www.alchemy.com/faucets/ethereum-sepolia)** or **[here](https://cloud.google.com/application/web3/faucet/ethereum/sepolia)**.
:::
...
![generalSettings](../../../assets/images/generalSettings.png)
...
![auctionSettings](../../../assets/images/auctionSettings.png)
...
![vetoPower](../../../assets/images/vetoPower.png)
...
![builderProperties](../../../assets/images/builderProperties.png)
...
![artLayer](../../../assets/images/artLayer.png)
...
![artPreview](../../../assets/images/artPreview.png)
...
![metadataDeploy](../../../assets/images/metadataDeploy.png)
...
![daoSettings](../../../assets/images/daoSettings.png)
...
![daoSettings2](../../../assets/images/daoSettings2.png)
