...
Open your DAO, select the **Proposals** tab and click **Create Proposal**. On the **Add Transactions** step, open the transaction type selector and choose **Stream Tokens**.
...
Open your DAO, select the **Proposals** tab and click **Create Proposal**. On the **Add Transactions** step, open the transaction type selector and choose **Airdrop Tokens**.
