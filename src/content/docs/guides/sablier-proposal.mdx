...
Go to your DAO's governance page and click **Submit Proposal**. On the **Add Transactions** step, open the transaction type selector and choose **Stream Tokens**.
...
Go to your DAO's governance page and click **Submit Proposal**. On the **Add Transactions** step, open the transaction type selector and choose **Airdrop Tokens**.
